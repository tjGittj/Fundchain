...
namespace EthereumStart.Services
{
    ...
    public class BasicEthereumService : IEthereumService
    {
        ...
        public async Task<Contract> GetContract(string name = "")
        {
           ...
           // string abi = @"[ { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' }, { 'name': '_addr', 'type': 'address' } ], 'name': 'addSellerToTF', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function', 'signature': '0x0563ac82' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' } ], 'name': 'getSellerCount', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0x1ce094d6' }, { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'addFundsToBuyer', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': true, 'stateMutability': 'payable', 'type': 'function', 'signature': '0x4a265ea5' }, { 'constant': false, 'inputs': [ { 'name': '_name', 'type': 'string' } ], 'name': 'createTradingFloor', 'outputs': [ { 'name': '', 'type': 'uint256' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function', 'signature': '0x4d7c678a' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'getSellerBalance', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0x602a8872' }, { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'addFundsToSeller', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': true, 'stateMutability': 'payable', 'type': 'function', 'signature': '0x89cb6f41' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'getBuyerBalance', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0xbc944d24' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' } ], 'name': 'getBuyerCount', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0xc8fa6a09' }, { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' }, { 'name': '_addr', 'type': 'address' } ], 'name': 'addBuyerToTF', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function', 'signature': '0xca0af271' } ]";

            string abi = @"[ { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' }, { 'name': '_addr', 'type': 'address' } ], 'name': 'addSellerToTF', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function', 'signature': '0x0563ac82' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' } ], 'name': 'getSellerCount', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0x1ce094d6' }, { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'addFundsToBuyer', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': true, 'stateMutability': 'payable', 'type': 'function', 'signature': '0x4a265ea5' }, { 'constant': false, 'inputs': [ { 'name': '_name', 'type': 'string' } ], 'name': 'createTradingFloor', 'outputs': [ { 'name': '', 'type': 'uint256' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function', 'signature': '0x4d7c678a' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'getSellerBalance', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0x602a8872' }, { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'addFundsToSeller', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': true, 'stateMutability': 'payable', 'type': 'function', 'signature': '0x89cb6f41' }, { 'constant': true, 'inputs': [], 'name': 'getTradingFloorCount', 'outputs': [ { 'name': '', 'type': 'int256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0xaf16280f' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' } ], 'name': 'getBuyerBalance', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0xbc944d24' }, { 'constant': true, 'inputs': [ { 'name': '_tfname', 'type': 'string' } ], 'name': 'getBuyerCount', 'outputs': [ { 'name': '', 'type': 'uint256', 'value': '0' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function', 'signature': '0xc8fa6a09' }, { 'constant': false, 'inputs': [ { 'name': '_tfname', 'type': 'string' }, { 'name': '_name', 'type': 'string' }, { 'name': '_addr', 'type': 'address' } ], 'name': 'addBuyerToTF', 'outputs': [ { 'name': '', 'type': 'bool' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function', 'signature': '0xca0af271' } ]";
